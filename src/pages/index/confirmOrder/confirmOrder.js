...
Page({
  ...
  readDetail(){
    wx.getStorage({
      key: 'detConfirm', success: (res) => {
        console.log(res)
        this.setData({ shopName: res.data.shopName, images: res.data.image, title: res.data.title, attrValues: res.data.attrValues, number: res.data.number, price: res.data.price, productType: res.data.productType, shopId: res.data.shopId, bussnessId: res.data.productId, attrIds: res.data.attrIds, bussnessCat: res.data.catId})
      }
    })
  },
  /**
